...
export function accountsPage(accounts: AccountRow[], csrfToken: string): RawHtml {
  return html`
    ...
    <details>
      ...
      <form hx-post="/admin/accounts" hx-target="#account-list" hx-swap="innerHTML">
    ...
    <div id="account-list">${accountList(accounts)}</div>
  `;
}
              ...
              <tr id="account-${a.id}">
                ...
                <td>
                  <details>
                    ...
                    <form hx-put="/admin/accounts/${a.id}/password" hx-target="#account-${a.id}" hx-swap="outerHTML">
                      <div class="grid">
