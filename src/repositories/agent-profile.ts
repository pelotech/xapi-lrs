...
export async function upsertAgentProfile(
  client: PoolClient,
  params: { profileId: string; agentIfi: string; contents: Buffer; contentType: string; lastModified: string },
): Promise<void> {
  await client.query({
    ...UPSERT_AGENT_PROFILE,
    values: [params.profileId, params.agentIfi, params.lastModified, params.contentType, params.contents.length, params.contents],
  });
}
